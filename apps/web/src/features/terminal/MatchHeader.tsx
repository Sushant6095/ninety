    ...
    <div className="border-b border-hairline px-4 py-3">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <span className={`rounded-chip bg-surface px-2 py-1 text-label font-semibold uppercase tracking-[0.1em] ring-1 ring-inset transition-colors duration-200 ${status === "HALTED" ? "text-halt ring-halt/40" : "text-lo ring-hairline"}`}>Market {status}</span>

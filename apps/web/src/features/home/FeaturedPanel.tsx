  ...
  return (
    <section className="elev-hi overflow-hidden rounded-card border border-hairline/70 bg-surface">
      <div className="flex items-center justify-between px-4 pt-3">
        <h2 className="text-label font-semibold uppercase tracking-[0.12em] text-lo">Featured — Live</h2>
        <span className="num inline-flex items-center gap-1 text-label text-up">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <span className="flex flex-col items-center gap-1">
          ...
          <span className="text-label font-medium tracking-wide text-lo">{live.homeCode}</span>
        </span>
        <span className="num font-display text-display-xl font-extrabold leading-none tabular-nums text-hi">
          {live.score?.home}<span className="px-1 text-lo">–</span>{live.score?.away}
        </span>
        <span className="flex flex-col items-center gap-1">
          <Flag code={live.awayCode} size={40} />
          <span className="text-label font-medium tracking-wide text-lo">{live.awayCode}</span>
        </span>
      </div>

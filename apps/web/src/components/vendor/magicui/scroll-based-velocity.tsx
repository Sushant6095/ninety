...
// magicui "scroll-based-velocity" (magicui.design/r/scroll-based-velocity), re-skinned to Ninety:
// - `motion/react` → "framer-motion"
// - prefers-reduced-motion now STOPS the marquee dead (the pull kept crawling at base velocity
//   under PRM — a law violation); the landing callsite additionally renders a static row
// - rAF already gates on IntersectionObserver + page visibility — kept as pulled
...
function ScrollVelocityRowImpl({
  ...
  useAnimationFrame((_, delta) => {
    // Reduced motion: no travel at all (the pull only slowed to base speed — not enough).

...
// useCyclePhase / useSteppedCycle (and their shared rAF bus) were deleted — only the
// other dotmatrix loaders used them, and dotm-square-3 is the only loader we ship.

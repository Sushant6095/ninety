...
export const MOMENTS: Moment[] = [
  ...
  { id: "m-ashour-74", matchId: "wc26-aus-egy", homeCode: "AUS", awayCode: "EGY", title: "Ashour's counter", outcome: "A", pick: "EGY", minute: 74, fromPrice: 31, toPrice: 55, owner: "@pitchwizard", ts: "today", mintSig: "5xQ…devnetAshour", segment: seg(31, 55) },
  ...
  { id: "m-srb-76", matchId: "wc26-srb-cmr", homeCode: "SRB", awayCode: "CMR", title: "Serbia seal it", outcome: "H", pick: "SRB", minute: 76, fromPrice: 72, toPrice: 92, owner: "@vd", ts: "today", mintSig: "2aP…devnetSerbia", segment: seg(72, 92) },
  ...
  { id: "m-bra-30", matchId: "wc26-bra-kor", homeCode: "BRA", awayCode: "KOR", title: "Brazil pull clear", outcome: "H", pick: "BRA", minute: 30, fromPrice: 71, toPrice: 84, owner: "@atlasfox", ts: "5 Jul", mintSig: "9vT…devnetBrazil", segment: seg(71, 84) },

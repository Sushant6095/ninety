...
DONE(bus): RedisBus implemented — XADD(MAXLEN~100k) · XGROUP@0 + XREADGROUP loop · XAUTOCLAIM recovery · graceful close(); integration test vs docker redis green (order · at-least-once · redeliver-once). See ADR-011.
